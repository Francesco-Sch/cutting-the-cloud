...
During my exploration of the website, my attention was quickly drawn to the very affordable smart home products. I found myself particularly intrigued by a battery-powered temperature sensor, prominently advertised as _Tuya WIFI Temperature Humidity Sensor Indoor Hygrometer Thermometer Detector Smart Life Remote Control Support Alexa Google Home_.[^1]
...
The price for one temperature sensor was 7,62€, which seems pretty low for for such a technical device. This led me to the following questions:
...
The following chapters are loose areas of research that I stumbled upon while attempting to hack the temperature sensors. The research is divided into broad chapters that together try to provide answers to the questions above.
