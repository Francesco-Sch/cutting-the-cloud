...
Another interesting point that came to my attention was that the TH08 temperature sensor and the other ones I bought (you can find a full list in the [second part of the documentation](/hacking-temperature-sensors/)) were available outside of Aliexpress. I could find several devices I bought on Aliexpress also on Amazon. The images, names and description differed only slightly but the real difference was in the price. Depending on the device the price on Amazon was up to 2.8x higher than the one on Aliexpress.
...
The [second part of this project](/hacking-temperature-sensors/), is all about the attempts taken to free the devices from the Tuya cloud ecosystem, to gain more control over the data usage and using the devices more freely.

[^1]: In the following the temperature sensors will be reffered to with their model number.
